...
const projects = [
  {
    ...
    description: "A large-scale commercial project with cranes and concrete structures reshaping the city skyline.",
  },
  {
    ...
    description: "Civil engineers collaborating on digital blueprints for smarter construction management.",
  },
  {
    ...
    description: "Development of modern residential housing aimed at redefining suburban comfort.",
  },
  {
    ...
    description: "High-speed rail infrastructure boosting urban mobility and economic growth.",
  },
  {
    ...
    description: "State-of-the-art overpass system improving traffic flow in major metropolitan areas.",
  },
  {
    ...
    description: "A major hydroelectric project generating clean energy and supporting sustainable growth.",
  },
]
